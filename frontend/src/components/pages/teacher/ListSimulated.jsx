 ...
 * @const simuladosMock
 * @description
 * Array de dados estáticos para simular uma lista de avaliações (simulados).
 * Usado para fins de desenvolvimento e demonstração da UI. Em um ambiente de produção,
 * estes dados viriam de uma API.
 *
 * @type {Array<Object>}
 * @property {string} nome - O título do simulado.
 * @property {string} disciplina - A disciplina associada ao simulado.
 * @property {string} status - O estado atual do simulado ("Corrigido" ou "Pendente").
 */
const simuladosMock = [
  {
